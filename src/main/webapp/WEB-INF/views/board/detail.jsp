  ...
  <body>
    ...
    <script>
      ...
      async function sendReaction(type) {
        ...
        const res = await fetch(`/board/\${type}?bno=\${bno}`);
        const { success, likeCount, dislikeCount, userReaction } = await res.json();
